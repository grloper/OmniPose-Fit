...
object AngleCalculator {
     ...
     * @param p2x X coordinate of middle point (the angle is calculated at this point)
     * @param p2y Y coordinate of middle point
    ...
    fun calculateAngle(
        ...
        // Vector from middle point to first point
        val v1x = p1x - p2x
        val v1y = p1y - p2y
        
        // Vector from middle point to third point
        val v2x = p3x - p2x
        val v2y = p3y - p2y
     ...
     * @return Angle in degrees
     */
    fun calculateVectorAngle(v1x: Float, v1y: Float, v2x: Float, v2y: Float): Float {
        // Calculate dot product
        val dotProduct = v1x * v2x + v1y * v2y
